...
Version that uses the normal vector interpolation at higher order
"""
...
def lin_eigval_err(pot_mesh, geo_mesh, K_ev):
    ...
    rel_err_arr = abs_err_arr / (eigval_3x3[i] * RDL_eig_helper.calc_ext_flow_magnitude((pot_type, mesh_type), pot_mesh, geo_mesh, psi))
    ret = {
